...
<!--			
		<tr>
			...
			<td width="30%" style="padding-left:10px">${content.rno }</td>
			<td width="20%">---</td>
			<td width="30%"></td>
		</tr>
  -->
  ...
  <style>
		...
		<tr>
			<td colspan="4" align="center">
				<input type="button" value="목록" onclick="location.href='re_list.re' ">&nbsp;&nbsp;
				
				<!-- 로그인 되어 있어야 글 수정시 수정, 삭제 버튼이 보임, 이미 로그인 완 생각안해도 되지? -->
				
				<input type="button" value="수정" onclick="location.href='re_modify.re?rno=${content.rno}&witer=${content.writer }'">&nbsp;&nbsp;
				<input type="button" value="삭제" onclick="location.href='re_delete.re?rno=${content.rno}&witer=${content.writer }'">&nbsp;&nbsp;
