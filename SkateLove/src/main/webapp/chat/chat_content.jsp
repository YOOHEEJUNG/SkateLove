	...
	<table border="1" width="500">
		...
		<tr>
			<td colspan="4" align="center">
				...
				<input type="button" value="수정" onclick="location.href='chat_modify.chat?chno=${vo.chno}&writer=${vo.writer }'">&nbsp;&nbsp;
				<input type="button" value="삭제" onclick="location.href='chat_delete.chat?chno=${vo.chno}&writer=${vo.writer }'">&nbsp;&nbsp;
			</td>
		</tr>
	</table>
